...
open class TagView: NSButton {
    ...
    @IBInspectable open var selectedTextColor: NSColor = NSColor.white {
        didSet {
            reloadStyles()
        }
    }
    @IBInspectable open var titleLineBreakMode: NSLineBreakMode = .byTruncatingMiddle {
        didSet {
            self.lineBreakMode = titleLineBreakMode
        }
    }
    ...
    @IBInspectable open var tagBackgroundColor: NSColor = NSColor.gray {
        didSet {
            reloadStyles()
        }
    }
    
    @IBInspectable open var highlightedBackgroundColor: NSColor? {
        didSet {
            reloadStyles()
        }
    }
    
    @IBInspectable open var selectedBorderColor: NSColor? {
        didSet {
            reloadStyles()
        }
    }
    
    @IBInspectable open var selectedBackgroundColor: NSColor? {
        didSet {
            reloadStyles()
        }
    }
    
    @IBInspectable open var textFont: NSFont = .systemFont(ofSize: 12) {
        didSet {
            title?.font = textFont
        }
    }
    ...
    @IBInspectable open var removeIconLineColor: NSColor = NSColor.white.withAlphaComponent(0.54) {
        didSet {
