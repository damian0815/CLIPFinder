...
// https://github.com/fancymax/AutoCompleteTextField/blob/master/AutoCompleteTextField.swift
...
extension AutoCompleteTextField:NSTableViewDelegate{
    ...
    func tableView(_ tableView: NSTableView, viewFor tableColumn: NSTableColumn?, row: Int) -> NSView? {
        let myViewIdentifier = NSUserInterfaceItemIdentifier(rawValue: "MyView")
        var cellView = tableView.makeView(withIdentifier: myViewIdentifier, owner: self) as? NSTableCellView
        if cellView == nil {
            ...
            cellView!.identifier = myViewIdentifier
        }
